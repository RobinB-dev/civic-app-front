...
export default function ({
  ...
  return (
    <View style={styles.fullScreen}>
      ...
      <Image source={require('../../assets/images/city.png')} style={styles.city}></Image>
        ...
        <Image source={require('../../assets/images/head_stars.png')} style={styles.headstars}></Image>
        <Text style={styles.mainText}>Vous avez gagné des points d’expérience !</Text>
        <View style={{flex: 1, width: '85%'}}>
        <TouchableOpacity style={styles.validateButton}>
          <Text style={styles.validateButtonText} onPress={() => {
