      ...
      >
        ...
        {!loading && (
          ...
          <Section style={styles.profileContainer }>
            <SectionContent style={{display: "flex", alignItems:"center", width: "100%", height:"60%",}}>
            <Image
           ...
           />
            ...
            <SectionContent style={{display: "flex", alignItems:"flex-start", width: "100%"}}>
              <View >
           ...
           <View style={styles.xpStar}>
             ...
             <Text style={styles.xpStarLevel}>12</Text>
              ...
              <View style ={styles.profMenu}>
                ...
                <Image source={require('../../assets/images/icons/plate.png')}></Image>
